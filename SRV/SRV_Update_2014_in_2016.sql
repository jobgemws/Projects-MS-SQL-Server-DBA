...
--
EXEC sys.sp_updateextendedproperty N'MS_Description', N'Поиск перекрывающихся(лишних) индексов', 'SCHEMA', N'srv', 'VIEW', N'vDelIndexInclude'
GO
...
--
EXEC sys.sp_addextendedproperty N'MS_Description', N'Статистика по функциям', 'SCHEMA', N'inf', 'VIEW', N'vFunctionStat'
GO
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
GO
