...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Устаревшее (описание внутри, использовалось до MS SQL Server 2012)', @level0type = N'SCHEMA', @level0name = N'inf', @level1type = N'PROCEDURE', @level1name = N'sp_WhoIsActive';
