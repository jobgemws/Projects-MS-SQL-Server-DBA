...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Статистика по триггерам', @level0type = N'SCHEMA', @level0name = N'inf', @level1type = N'VIEW', @level1name = N'vTriggerStat';
