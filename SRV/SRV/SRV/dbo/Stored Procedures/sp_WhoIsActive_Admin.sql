...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Монитор производительности СУБД', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'sp_WhoIsActive_Admin';
