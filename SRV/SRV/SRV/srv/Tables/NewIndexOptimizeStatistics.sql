...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Рекомендуемые индексы согласно собранной статистики', @level0type = N'SCHEMA', @level0name = N'srv', @level1type = N'TABLE', @level1name = N'NewIndexOptimizeStatistics';
