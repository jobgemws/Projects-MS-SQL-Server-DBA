...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Мониторинг SQL ожиданий', @level0type = N'SCHEMA', @level0name = N'srv', @level1type = N'PROCEDURE', @level1name = N'Get_Statistic_Waits';
