...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Выполняет тонкое обновление статистики', @level0type = N'SCHEMA', @level0name = N'srv', @level1type = N'PROCEDURE', @level1name = N'AutoUpdateStatistics';
