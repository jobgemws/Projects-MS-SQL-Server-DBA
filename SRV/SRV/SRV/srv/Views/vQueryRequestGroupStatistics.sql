...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Детальная информация по запросам экземпляра MS SQL Server (сгруппированная по запросам)', @level0type = N'SCHEMA', @level0name = N'srv', @level1type = N'VIEW', @level1name = N'vQueryRequestGroupStatistics';
