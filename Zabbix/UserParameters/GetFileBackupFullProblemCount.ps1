...
$SqlCmd.CommandText = "zabbix.GetFileBackupProblemCount";
$SqlCmd.Connection = $Connection;

$paramdiffSec=$SqlCmd.Parameters.Add("@path" , [System.Data.SqlDbType]::NVarCharVarChar);
$paramdiffSec.Value = $path;
