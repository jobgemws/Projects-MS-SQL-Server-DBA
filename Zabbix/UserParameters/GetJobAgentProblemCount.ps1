...
$SqlCmd.CommandText = "zabbix.GetJobAgentProblemCount";
$SqlCmd.Connection = $Connection;

$paramdiffSec=$SqlCmd.Parameters.Add("@run_minutes" , [System.Data.SqlDbType]::Int);
$paramdiffSec.Value = $run_minutes;
